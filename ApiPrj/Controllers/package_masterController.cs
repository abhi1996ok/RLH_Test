...
namespace ApiPrj.Controllers
{
    ...
    public class package_masterController : ApiController
    {
        ...
        //    {
        //        //return Request.CreateResponse(HttpStatusCode.Found,db.package_master.ToList());
        //        PackageMaster pck = new PackageMaster();
        //        return Ok(pck.PackConvter(db.package_master.ToList()));
        ...
        //        }
        //        PackageMaster pck = new PackageMaster();
        //        return Ok(pck.singlePack(package_master));
        //    }
        ...
        //    [ResponseType(typeof(package_master))]
        //    public HttpResponseMessage Getpackage_master(int id, bool destId, string destType,int price)
        //    {
        //        if (destId == false)
        //        {
        //            package_master package_master = db.package_master.Find(id);
        ...
        //        else
        //        {
        //            List<package_master> package_master = db.package_master.Include(e => e.keyword_master).ToList();
